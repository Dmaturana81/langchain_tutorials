...
# %% auto 0
__all__ = ['MultiRouteChain_openAIfunc', 'Conversational_chain', 'Sum_tool', 'Inpt_weather', 'Weather_cls', 'summatory',
           'Weather', 'create_router_template', 'create_router_chain', 'create_MultiChianRouter_o']
